...
OUTPUT_SVG = os.path.join(os.path.dirname(__file__), "..", "education-card.svg")
...
def make_education_card():
    ...
    svg_parts.append(f'<text x="{width / 2}" y="21" text-anchor="middle" class="term-title">akshat@evershtar: ~/education (zsh)</text>')

    # Spacious Academic Lines
    rows = [
        {"y": 58, "delay": 0.05, "content": '<tspan class="prompt-user">akshat@evershtar</tspan><tspan class="prompt-colon">:</tspan><tspan class="prompt-path">~/education</tspan><tspan class="prompt-symbol"> $ </tspan><tspan class="cmd">cat degree-information.md --verbose</tspan> <tspan class="cursor">█</tspan>'},
        {"y": 84, "delay": 0.1, "content": '<tspan class="key">Degree  :</tspan> <tspan class="val-bold">B.Tech in Computer Science &amp; Artificial Intelligence</tspan>'},
        {"y": 108, "delay": 0.15, "content": '<tspan class="key">Campus  :</tspan> <tspan class="accent">Newton School of Technology (NST)</tspan> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; <tspan class="key">Status  :</tspan> <tspan class="val-bold">1st Semester</tspan>'},
    ]
    ...
    print(f"Successfully generated clean Education Terminal Card SVG: {OUTPUT_SVG}")
